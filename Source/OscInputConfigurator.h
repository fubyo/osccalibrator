...
class OscInputConfigurator  : public Component,
                              public ButtonListener
{
public:
    //==============================================================================
    OscInputConfigurator ();
    ~OscInputConfigurator();
...
private:
    ...
    OscInputConfigurator (const OscInputConfigurator&);
    const OscInputConfigurator& operator= (const OscInputConfigurator&);
};